...
import { updateAudioTime, updateProgressBar, highlightCurrentSong } from "./other.js";
...
export function playSong(index = null) {
    ...
    musicState.audio.addEventListener("timeupdate", () => {
      const progress = (musicState.audio.currentTime / musicState.audio.duration) * 100;
    ...
    songsInfo.innerHTML = `Title: ${
      musicState.songs[musicState.songCount].attributes.name
    }`;
